                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="mb-3">
                            ...
                            <textarea class="custom-textarea" name="short_description">{{ $item->short_description }}</textarea>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <label for="long_description" class="form-label">Long Description</label>
                            <textarea class="custom-textarea" name="long_description">{{ $item->long_description }}</textarea>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <label for="change_log" class="form-label">Change Log</label>
                            <textarea class="custom-textarea" name="change_log">{{ $item->change_log }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="mb-3">
                            ...
                            <textarea class="custom-textarea" name="comment" rows="3">{{ $item->comment }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
