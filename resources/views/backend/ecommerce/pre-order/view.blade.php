                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-6 text-start">
                                <h5>Invoice Date:</h5>
                                <span id="invoiceDate">{{ $preOrder->created_at->format('d-m-Y') }}</span>
                            </div>
                        </div>
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="subtotalValue" class="text-end">{{ $preOrder->sub_total }}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="4" class="text-end"><strong>Delivery Charge</strong></td>
                                        <td id="deliveryChargeValue" class="text-end">{{ $preOrder->delivery_charge }}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="4" class="text-end"><strong>Total</strong></td>
                                        <td id="totalValue" class="text-end"><strong>{{ $preOrder->total }}</strong></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="col-6 mb-3">
                            <h6>Order Note</h6>
                            <span id="orderNote">{{ $preOrder->order_note }}</span>
                        </div>
                        <div class="mb-5">
                            <p>Invoice # <span id="UUID">{{ $preOrder->uuid }}</span></p>
                        </div>
                    </div>
                </div>
            </div>
