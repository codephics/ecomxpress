...
<main class="container p-3 py-5">
    ...
    <form class="needs-validation" method="POST" action="{{ route('ecommerce.subcategory.update',$subcategory->id) }}" enctype="multipart/form-data" novalidate>
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-3">
                            <img src="{{ asset('ecommerce/category/subcategory/image/icon/' . $subcategory->icon) }}" class="img-thumbnail" alt="...">
                        </div>
                        <div class="mb-3">
                            <input class="form-control" type="text" name="icon_alt_text" value="{{ $subcategory->icon_alt_text }}" placeholder="Icon Alt Text" />
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <img src="{{ asset('ecommerce/category/subcategory/image/thumb/' . $subcategory->thumb) }}" class="img-thumbnail" alt="...">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            <img src="{{ asset('ecommerce/category/subcategory/image/cover/' . $subcategory->cover) }}" class="img-thumbnail" alt="...">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <img src="{{ asset('ecommerce/category/subcategory/image/og/' . $subcategory->og_image) }}" class="img-thumbnail" alt="...">
                        </div>
                        <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="meta_title" rows="5">{{ $subcategory->meta_title }}</textarea>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="mb-3">
                            <label for="meta_description" class="form-label">Meta Description</label>
                            <textarea class="form-control" name="meta_description" rows="5">{{ $subcategory->meta_description }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="custom-textarea" name="comment" rows="3">{{ $subcategory->comment }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
