        ...
        <div class="col-lg-2 align-self-center">
            <div class="row">
                <div class="col-12 col-sm-12">
                    <a type="button" class="btn btn-outline-secondary float-end" href="{{ route('slider.new') }}">+ Add Slider</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                              ...
                              <button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#deleteSlider{{ $slider->id }}">Destroy</button>

                                <!-- Modal -->
                                <div class="modal fade" id="deleteSlider{{ $slider->id }}" tabindex="-1" aria-labelledby="deleteSliderLabel" aria-hidden="true">
