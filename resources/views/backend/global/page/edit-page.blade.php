...
<main class="container p-3 py-5">
    ...
    <form class="needs-validation" method="POST" action="{{ route('page.update', $page->id) }}" enctype="multipart/form-data" novalidate>
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="mb-3">
                            ...
                            <textarea class="custom-textarea" name="short_description">{{ $page->short_description }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="mb-3">
                            ...
                            <textarea class="custom-textarea" name="long_description">{{ $page->long_description }}</textarea>
                        </div>
                    </div>
                </div>
