                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="{{ asset('global/blog/image/featured/' . $blog->featured_image) }}" class="img-thumbnail" alt="..." />
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="{{ asset('global/blog/image/og/' . $blog->og_image) }}" class="img-thumbnail" alt="..." />
                        </div>
                        <div class="mb-3">
