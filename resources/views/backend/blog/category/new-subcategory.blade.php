...
<main class="container p-3 py-5">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Blog Subcategory</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <form class="needs-validation" method="POST" action="{{ route('blog.new-subcategory.store') }}" enctype="multipart/form-data" novalidate>
        @csrf
        <div class="row">
            <div class="col-sm-9">
                <div class="row">
