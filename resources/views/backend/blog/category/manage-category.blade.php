        ...
        <div class="col-lg-4 align-self-center">
            <div class="row">
                <div class="col-12 col-sm-12">
                    <a type="button" class="btn btn-outline-secondary float-end" href="{{ route('blog.new-category') }}">+ Add Blog Category</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            ...
            <table id="example" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><img src="{{ asset('global/weblog/image/category/icon/' . $category->icon) }}" class="" alt="..." height="42" width="42" /></td>
                        <td>{{ $category->category_name }}</td>
                        <td>{{ $category->slug }}</td>
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                              <a href="{{ route('blog.category.edit',$category->id) }}" class="btn btn-secondary">Edit</a>
