...
<main class="container p-3 py-5">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('blog.categories') }}">Manage Categories</a></li>
    ...
    <form class="needs-validation" method="POST" action="{{ route('blog.new-category.store') }}" enctype="multipart/form-data" novalidate>
        @csrf
        <div class="row">
            <div class="col-sm-9">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="twitter_meta_description" rows="4"></textarea>
                        </div>
                    </div>
                </div>
            </div>
