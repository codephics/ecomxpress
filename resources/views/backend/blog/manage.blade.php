@extends('backend.skeleton.body') @section('custom-head')
        ...
        <div class="col-lg-2 align-self-center">
            <div class="row">
                <div class="col-12 col-sm-12">
                    <a type="button" class="btn btn-outline-secondary float-end" href="{{ route('blog.new') }}">+ Add Blog</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <table id="example" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><img src="{{ asset('global/weblog/image/featured/' . $blog->featured_image) }}" class="" alt="..." height="42" width="42" /></td>
                        <td>{{ $blog->title }}</td>
                        <td>{{ $blog->tags }}</td>
